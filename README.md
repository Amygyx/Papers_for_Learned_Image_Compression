# Papers for Learned Image Compression
**Purpose:** We aim to provide a summary of learned image compression. More papers will be summarized.

University of Science and Technology of China (USTC), [Intelligent Media Computing Lab](https://faculty.ustc.edu.cn/chenzhibo).

**📌 About new works.** If you want to incorporate your studies (e.g., the link of paper or project) on learned image compression in this repository. Welcome to raise an issue or email us. We will incorporate it into this repository and our survey report as soon as possible.
...
| -- | [Causal Contextual Prediction for Learned Image Compression](https://doi.org/10.1109/TCSVT.2021.3089491) | Zongyu Guo | TCSVT2022 | — |
...
| RDEIC | [RDEIC: Accelerating Diffusion-Based Extreme Image Compression with Relay Residual Diffusion](https://doi.org/10.1109/TCSVT.2025.3578127) | Zhiyuan Li | TCSVT2025 | [![Stars](https://img.shields.io/github/stars/huai-chang/RDEIC.svg?style=social&label=Star)](https://github.com/huai-chang/RDEIC) |
...
| DiffC | [Lossy Compression with Gaussian Diffusion](https://arxiv.org/abs/2206.08889) | Lucas Theis | arXiv2022 | — |
