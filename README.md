...
| :--: | --- | --- | --- | --- | :--: |
| 2026 | [An Overview of the JPEG AI Learning-Based Image Coding Standard](https://doi.org/10.1109/TCSVT.2025.3613244)<br><sub>Describes the first published end-to-end learning-based image coding standard and its interoperable coding pipeline.</sub> | S. Esenlik | IEEE TCSVT | `transform` · `standardization` · `practical` | [link](https://jpeg.org/jpegai/) |
...
| 2023 | [An Introduction to Neural Data Compression](https://www.nowpublishers.com/article/Details/CGV-107)<br><sub>A tutorial treatment of learned compression that connects probabilistic modeling, quantization, and rate-distortion learning.</sub> | Yibo Yang | Foundations and Trends in Computer Graphics and Vision | `transform` · `benchmark` | — |
...
| Year | Paper | First author | Venue | Tags | Code / project |
| :--: | --- | --- | --- | --- | :--: |
| 2025 | [Fitted Neural Lossless Image Compression](https://openaccess.thecvf.com/content/CVPR2025/html/Zhang_Fitted_Neural_Lossless_Image_Compression_CVPR_2025_paper.html)<br><sub>Combines a dataset-level prior with per-image fitting to reduce decoding complexity while retaining competitive lossless rates.</sub> | Zhe Zhang | CVPR | `lossless` · `overfitted` · `entropy-model` · `adaptation` · `low-complexity` | [link](https://github.com/ZZ022/FNLIC) |
| 2025 | [Large Language Model for Lossless Image Compression with Visual Prompts](https://openreview.net/forum?id=dcG17rjJF9) | Junhao Du | ICLR | `lossless` · `foundation-model` · `entropy-model` | — |
| 2025 | [Large Language Models for Lossless Image Compression: Next-Pixel Prediction in Language Space is All You Need](https://openreview.net/forum?id=FXBBy1caOX)<br><sub>Recasts lossless image entropy modeling as next-pixel prediction with a large language model.</sub> | Kecheng Chen | NeurIPS | `lossless` · `foundation-model` · `entropy-model` | — |
| 2025 | [Towards Lossless Implicit Neural Representation via Bit Plane Decomposition](https://openaccess.thecvf.com/content/CVPR2025/html/Han_Towards_Lossless_Implicit_Neural_Representation_via_Bit_Plane_Decomposition_CVPR_2025_paper.html) | Woo Kyoung Han | CVPR | `lossless` · `inr` · `quantization` | [link](https://github.com/WooKyoungHan/LosslessINR) |
| 2024 | [Deep Lossy Plus Residual Coding for Lossless and Near-lossless Image Compression](https://ieeexplore.ieee.org/document/10378746) | Yuanchao Bai | IEEE TPAMI | `near-lossless` · `transform` · `entropy-model` · `scalable` | [link](https://github.com/BYchao100/Deep-Lossy-Plus-Residual-Coding) |
...
| 2021 | [Improving Lossless Compression Rates via Monte Carlo Bits-Back Coding](https://arxiv.org/abs/2102.11086) | Yangjun Ruan | ICML | `lossless` · `flow` · `entropy-model` | [link](https://github.com/ryoungj/mcbits) |
...
| 2019 | [Practical Full Resolution Learned Lossless Image Compression](https://openaccess.thecvf.com/content_CVPR_2019/html/Mentzer_Practical_Full_Resolution_Learned_Lossless_Image_Compression_CVPR_2019_paper.html)<br><sub>Established a practical, parallel hierarchical probabilistic model for full-resolution learned lossless coding.</sub> | Fabian Mentzer | CVPR | `lossless` · `autoregressive` · `entropy-model` · `practical` | [link](https://github.com/fab-jul/L3C-PyTorch) |
...
| 2024 | [BaSIC: BayesNet Structure Learning for Computational Scalable Neural Image Compression](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/03640.pdf) | Yufeng Zhang | ECCV | `distortion` · `transform` · `entropy-model` · `low-complexity` | [link](https://github.com/worldlife123/cbench_BaSIC) |
...
| 2023 | [Learned Image Compression with Mixed Transformer-CNN Architectures](https://openaccess.thecvf.com/content/CVPR2023/html/Liu_Learned_Image_Compression_With_Mixed_Transformer-CNN_Architectures_CVPR_2023_paper.html) | Jinming Liu | CVPR | `distortion` · `transform` · `entropy-model` | [link](https://github.com/jmliu206/LIC_TCM) |
| 2023 | [NVTC: Nonlinear Vector Transform Coding](https://openaccess.thecvf.com/content/CVPR2023/html/Feng_NVTC_Nonlinear_Vector_Transform_Coding_CVPR_2023_paper.html) | Runsen Feng | CVPR | `distortion` · `vq` · `transform` · `quantization` | [link](https://github.com/USTC-IMCL/NVTC) |
...
| 2022 | [The Devil Is in the Details: Window-Based Attention for Image Compression](https://openaccess.thecvf.com/content/CVPR2022/html/Zou_The_Devil_Is_in_the_Details_Window-Based_Attention_for_Image_CVPR_2022_paper.html) | Renjie Zou | CVPR | `distortion` · `transform` · `entropy-model` | [link](https://github.com/Googolxx/STF) |
...
| 2018 | [Joint Autoregressive and Hierarchical Priors for Learned Image Compression](https://proceedings.neurips.cc/paper/2018/hash/53edebc543333dfbf7c5933af792c9c4-Abstract.html)<br><sub>Combined autoregressive context and hierarchical side information into a foundational learned entropy model.</sub> | David Minnen | NeurIPS | `distortion` · `transform` · `entropy-model` | [link](https://github.com/tensorflow/compression) |
| 2018 | [Variational Image Compression with a Scale Hyperprior](https://openreview.net/forum?id=rkcQFMZRb)<br><sub>Introduced the scale hyperprior that became a standard building block for learned image codecs.</sub> | Johannes Balle | ICLR | `distortion` · `transform` · `entropy-model` | [link](https://github.com/tensorflow/compression) |
| 2017 | [End-to-end Optimized Image Compression](https://openreview.net/forum?id=rJxdQ3jeg)<br><sub>Established the end-to-end rate-distortion training formulation for nonlinear transform coding.</sub> | Johannes Balle | ICLR | `distortion` · `transform` · `quantization` · `entropy-model` | [link](https://github.com/tensorflow/compression) |
...
| 2026 | [CoD: A Diffusion Foundation Model for Image Compression](https://openaccess.thecvf.com/content/CVPR2026/html/Jia_CoD_A_Diffusion_Foundation_Model_for_Image_Compression_CVPR_2026_paper.html)<br><sub>Trains a compression-oriented diffusion foundation model rather than adapting a text-to-image model to coding.</sub> | Zhaoyang Jia | CVPR | `perception` · `diffusion` · `foundation-model` · `transform` · `optimization` · `low-complexity` | [link](https://github.com/microsoft/GenCodec/tree/main/CoD) |
| 2026 | [DiT-IC: Aligned Diffusion Transformer for Efficient Image Compression](https://openaccess.thecvf.com/content/CVPR2026/html/Shi_DiT-IC_Aligned_Diffusion_Transformer_for_Efficient_Image_Compression_CVPR_2026_paper.html)<br><sub>Aligns a diffusion transformer to compact codec latents and reduces reconstruction to one denoising step.</sub> | Junqi Shi | CVPR | `perception` · `diffusion` · `transform` · `optimization` · `low-complexity` · `practical` | — |
...
| 2026 | [What Matters in Practical Learned Image Compression](https://openaccess.thecvf.com/content/CVPR2026/html/Tatwawadi_What_Matters_in_Practical_Learned_Image_Compression_CVPR_2026_paper.html)<br><sub>Studies perceptual quality and runtime jointly and demonstrates on-device learned image coding.</sub> | Kedar Tatwawadi | CVPR | `perception` · `transform` · `optimization` · `low-complexity` · `practical` · `variable-rate` | — |
...
| 2025 | [Good, Cheap, and Fast: Overfitted Image Compression with Wasserstein Distortion](https://openaccess.thecvf.com/content/CVPR2025/html/Balle_Good_Cheap_and_Fast_Overfitted_Image_Compression_with_Wasserstein_Distortion_CVPR_2025_paper.html)<br><sub>Uses Wasserstein distortion to obtain strong human-rated perceptual quality with very low decoding complexity.</sub> | Jona Balle | CVPR | `perception` · `overfitted` · `optimization` · `low-complexity` | — |
| 2023 | [Lossy Image Compression with Conditional Diffusion Models](https://proceedings.neurips.cc/paper_files/paper/2023/hash/ccf6d8b4a1fe9d9c8192f00c713872ea-Abstract-Conference.html)<br><sub>A foundational conditional-diffusion codec for perceptual reconstruction at low bitrates.</sub> | Ruihan Yang | NeurIPS | `perception` · `diffusion` · `transform` · `optimization` | [link](https://github.com/buggyyang/CDC_compression) |
| 2020 | [High-Fidelity Generative Image Compression](https://proceedings.neurips.cc/paper/2020/hash/8a50bae297807da9e97722a0b3fd8f27-Abstract.html)<br><sub>Established a widely used GAN-based codec and a strong operating point on the rate-distortion-perception surface.</sub> | Fabian Mentzer | NeurIPS | `perception` · `gan` · `optimization` | [link](https://github.com/tensorflow/compression/tree/master/models/hific) |
...
| 2019 | [Rethinking Lossy Compression: The Rate-Distortion-Perception Tradeoff](https://proceedings.mlr.press/v97/blau19a.html)<br><sub>Formalized the rate-distortion-perception trade-off that underpins modern generative compression.</sub> | Yochai Blau | ICML | `perception` · `gan` · `optimization` | — |
...
| Year | Paper | First author | Venue | Tags | Code / project |
| :--: | --- | --- | --- | --- | :--: |
| 2024 | [High Frequency Matters: Uncertainty Guided Image Compression with Wavelet Diffusion](https://arxiv.org/abs/2407.12538) | Juan Song | arXiv (Preprint) | `perception` · `diffusion` · `transform` · `optimization` · `content-adaptive` | [link](https://github.com/hejiaxiang1/Wavelet-Diffusion) |
