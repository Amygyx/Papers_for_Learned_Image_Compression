...
def render(data: dict, papers: list[dict]) -> str:
    ...
    lines = [
        ...
        "",
        "A curated research map for neural still-image compression, maintained by the "
        "[Intelligent Media Computing Lab at USTC](https://faculty.ustc.edu.cn/chenzhibo).",
        "",
